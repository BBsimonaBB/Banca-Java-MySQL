...
public class UserHome extends JFrame {
    ...
    public UserHome(String userSes,Connection connection) {
        ...
        if(tip == 0) {
            JComboBox meniuAdmin = new JComboBox(new String[]{"Detalii contract de munca","Modificare clienti","Vizualizare clienti","Notificari"});
            ;
            ...
            next.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if(meniuAdmin.getItemAt(meniuAdmin.getSelectedIndex()).equals("Detalii contract de munca")){
                        DetaliiContractAdmin detalii = new DetaliiContractAdmin(id,connection);
                        detalii.setVisible(true);
                        detalii.setTitle("Detalii Contract Admin");
                    }
                    if(meniuAdmin.getItemAt(meniuAdmin.getSelectedIndex()).equals("Modificare clienti")){
                        ModificareClienti modif = new ModificareClienti(id, connection);
                        modif.setVisible(true);
                        modif.setTitle("Modificare Utilizatori");
                    }
                    if(meniuAdmin.getItemAt(meniuAdmin.getSelectedIndex()).equals("Vizualizare clienti")){
                        VizualizareClienti view = new VizualizareClienti(id,connection);
                        view.setVisible(true);
                        view.setTitle("Vizualizare Clienti");
                    }
                    if(meniuAdmin.getItemAt(meniuAdmin.getSelectedIndex()).equals("Notificari")){
                        NotificariAdmin notif = new NotificariAdmin(id,connection);
            ...
            next.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if(meniuClient.getItemAt(meniuClient.getSelectedIndex()).equals("Lichidare depozit")){
                        LichidareDepozit lichidez = new LichidareDepozit(id,connection);
                        lichidez.setVisible(true);
                        lichidez.setTitle("Lichidare depozit");
                    }
                    //ROBTRL25818576
